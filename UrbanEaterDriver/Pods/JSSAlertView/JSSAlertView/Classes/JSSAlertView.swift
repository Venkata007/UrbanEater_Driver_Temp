...
open class JSSAlertView: UIViewController {
	...
	var titleFont = "Roboto-Regular"
	var textFont = "Roboto-Light"
	var buttonFont = "Roboto-Bold"
    var timerFont = "Roboto-Regular"
	...
	open override func viewDidLayoutSubviews() {
		...
		if !noButtons {
			...
			// set button fonts
			if buttonLabel != nil {
				buttonLabel.font = UIFont(name: buttonFont, size: 18)
			}
			if cancelButtonLabel != nil {
				cancelButtonLabel.font = UIFont(name: buttonFont, size: 18)
			}
			yPos += buttonHeight
		}else{
			yPos += padding
	...
	public func show(_ viewController: UIViewController,
		...
		alertBackgroundView.backgroundColor = #colorLiteral(red: 1.0, green: 1.0, blue: 1.0, alpha: 1.0)//baseColor
        ...
        if let time = timeLeft {
            ...
            self.timeLeft = time
            self.timerLabel.font = UIFont(name: self.timerFont, size: 24)
		...
		if !noButtons {
			...
			let buttonColor = UIImage.with(color: adjustBrightness(baseColor!, amount: 1.0))
			let buttonHighlightColor = UIImage.with(color: adjustBrightness(baseColor!, amount: 1.0))
			...
			// Button text
			buttonLabel = UILabel()
			buttonLabel.textColor = #colorLiteral(red: 1.0, green: 1.0, blue: 1.0, alpha: 1.0)
			...
			if cancelButtonText != nil {
				...
				cancelButtonLabel.textColor = #colorLiteral(red: 1.0, green: 1.0, blue: 1.0, alpha: 1.0)
	...
	func setFont(_ fontStr: String, type: FontType) {
		...
		case .button:
			...
			if let font = UIFont(name: self.buttonFont, size: 18) {
				...
				self.buttonLabel.font = UIFont.systemFont(ofSize: 18)
			}
        case .timer:
