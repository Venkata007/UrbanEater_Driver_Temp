...
public extension UIView {
    ...
    func makeToast(message msg: String, duration: Double, position: AnyObject, title: String, withConfiguration config: HRToastConfig = HRToastConfig()) {
        ...
        showToast(toast: toast!, duration: duration, position: HRToastPositionDefault as AnyObject, withConfiguration: config)
    }
    ...
    fileprivate func addContentsStackView(toWrapperView wrapperView: UIView, withConfiguration config: HRToastConfig) -> UIStackView {
        ...
        stackView.setContentHuggingPriority(UILayoutPriority.init(1000), for: .vertical)
        stackView.setContentHuggingPriority(UILayoutPriority.init(1000), for: .horizontal)
        ...
        leftSideConstraint.priority = UILayoutPriority.init(1000)
        ...
        rightSideConstraint.priority = UILayoutPriority.init(1000)
        ...
        leftSideEqualConstraint.priority = UILayoutPriority.init(250)
        ...
        rightSideEqualConstraint.priority = UILayoutPriority.init(250)
    ...
    fileprivate func addImage(_ image: UIImage, toStackView stackView: UIStackView) {
        ...
        imageView.setContentHuggingPriority(UILayoutPriority.init(1000), for: .horizontal)
        imageView.setContentHuggingPriority(UILayoutPriority.init(1000), for: .vertical)
    ...
    fileprivate func addMessage(_ msg: String?, andTitle title: String?, toStackView parentStackView: UIStackView, withConfiguration config: HRToastConfig) {
        ...
        if let title = title {
            ...
            titleLabel.setContentHuggingPriority(UILayoutPriority.init(751), for: .vertical)
        ...
        if let msg = msg {
            ...
            msgLabel.setContentHuggingPriority(UILayoutPriority.init(751), for: .vertical)
